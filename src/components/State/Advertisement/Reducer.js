    ...
    switch(action.type) {
        ...
        case DELETE_ADVERTISEMENT_SUCCESS:
            return {
                ...
                error: null,
                loading: true,
                advertisements: state.advertisements.filter((item) => item.id !== action.payload),
            };
